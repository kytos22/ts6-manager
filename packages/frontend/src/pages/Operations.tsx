...
export default function Operations() {
  ...
  const snapshotWarning = health.data?.compatibility?.keepFilesFixed === false
    ? 'This server version can hang when restoring with Keep channel files. Update to TS6 beta13 or later before restoring.'
    : health.data?.compatibility?.keepFilesFixed !== true
      ? 'Snapshot compatibility has not been verified. Check the server version before restoring.'
      : null;
