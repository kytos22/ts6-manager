...
import {
  ...
  Image as ImageIcon, Activity, History,
} from 'lucide-react';
...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/icons', icon: ImageIcon, label: 'nav.iconManager', adminOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/operations', icon: Activity, label: 'nav.operations', adminOnly: true },
